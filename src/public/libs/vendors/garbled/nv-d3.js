        ...
        selection.each(function(data) {
            ...
            function mouseHandler() {
                ...
                if (mouseX < 0 || mouseY < 0
                    ...
                    //tooltip.hidden(true);/*by heimanba*/
                    return;
                } else {
            ...
            layer.renderGuideLine = function(x) {
                ...
                nv.dom.write(function() {
                    ...
                    line.enter()
                        ...
                        .attr("y2",0);
                        // line.exit().remove();  /*xiaoyq*/
                });
          };

          layer.renderGuideLiney = function(y) {
                if (!showGuideLine) return;
                if (layer.guideLine && layer.guideLine.attr("y1") === y) return;
                nv.dom.write(function() {
                    var line = wrap.select(".nv-interactiveGuideLine")
                        .selectAll("line")
                        .data((y != null) ? [nv.utils.NaNtoZero(y)] : [], String);
                    line.enter()
                        .append("line")
                        .attr("class", "nv-guideline")
                        .attr("y1", function(d) { return d;})
                        .attr("y2", function(d) { return d;})
                        .attr("x1", availableWidth)
                        .attr("x2",0);
                    line.exit().remove();
                });  /*xiaoyq*/
            }
    ...
    function initTooltip() {
        if (!tooltip) {
            ...
            tooltip = d3.select(container).append("div")
                .attr("class", "nvtooltip j_nv_tooltip " + (classes ? classes : "xy-tooltip"))
                .attr("id", id);
                ...
                case 'left':
                    ...
                    if (showMaxMin) {
                        ...
                        axisMaxMin
                            ...
                            .attr('dy', '.32em')
                            .attr('y', 0)
                            .attr('x', -axis.tickPadding()/6 + 'em')/*heimanba*/
        ...
        selection.each(function(data) {
            ...
            switch(vers) {
                case 'furious' :
                    ...
                    break;
                case 'classic' :
                    versPadding = dpr2px(24);//heimanba
            }

            if(vers == 'classic') {
                seriesEnter.append('circle')
                    .style('stroke-width', dpr2px(5))
                    .attr('class','nv-legend-symbol')
                    .attr('r', dpr2px(6) );
            ...
            if (align) {
                ...
                series
                    .attr('transform', function(d, i) {
                        ...
                        ypos += versPadding;//add heimanba

                        if (width < margin.left + margin.right + xpos + length) {
                            newxpos = xpos = 5;
                            //ypos += versPadding; //remove heimanba
                        }
                ...
                //add heimanba    
                g.attr('transform', 'translate(' + (width - margin.right - dpr2px(100)) + ',' + margin.top + ')');
...
nv.models.line = function() {
    ...
    function chart_defs(selector, d){/*by heimanba*/
        var defs_d3 = selector.append('defs')
        var grad_d3 = defs_d3.append("linearGradient")
                ...
                grad_d3.append("stop")
                .attr("offset","0%")
                .attr("style","stop-color:"+d.color+";stop-opacity:0.6");
                grad_d3.append("stop")
                .attr("offset","100%")
                .attr("style","stop-color:#ecd8fe;stop-opacity:0.6");
    ...
    function chart(selection) {
        ...
        selection.each(function(data) {
            ...
            groups
                ...
                .classed('hover', function(d) { return d.hover })
                .style('fill', function(d, i){   return chart_defs(wrapEnter, d)/*by heimanba*/
                    /*color(d, i)*/  })
                .style('stroke', function(d,i){ return color(d, i)});
...
nv.models.lineChart = function() {
    ...
    function chart(selection) {
        ...
        selection.each(function(data) {
            ...
            interactiveLayer.dispatch.on('elementMousemove', function(e) {
                lines.clearHighlights();
                var singlePoint, pointIndex, pointXLocation, pointYLocation, allData = [];/*xiaoyq*/
                data
                    .filter(function(series, i) {
                        series.seriesIndex = i;
                    ...
                    .forEach(function(series,i) {
                        ...
                        if (singlePoint === undefined) singlePoint = point;
                        if (pointXLocation === undefined) pointXLocation = chart.xScale()(chart.x()(point,pointIndex));
                        if (pointYLocation === undefined) pointYLocation = chart.yScale()(chart.y()(point,pointIndex));/*xiaoyq*/
                        allData.push({
                            key: series.key,
                            value: pointYValue,
                            color: color(series,series.seriesIndex),
                ...
                interactiveLayer.renderGuideLiney(pointYLocation);/*xiaoyq*/
                interactiveLayer.renderGuideLine(pointXLocation);
