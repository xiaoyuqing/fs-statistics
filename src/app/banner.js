...
import api from './conf/api/banner'
import mapFilter from './conf/filter/banner'
import dataMaps from './conf/map/banner'
...
try{	
	angular.bootstrap(document.body, ['fs.banner']);
}catch(e){
	basket.clear();
	alert('请刷新页面重试')
}	
